...
func main() {
	...
	flag.BoolVar(&cfg.prettyLogger, "pretty-logger", false, "Whether should print logs in pretty format or not")
	...
	flag.StringVar(&cfg.smtp.host, "smtp-host", "smtp.c1.liara.email", "SMTP host")
